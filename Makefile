...
#     PREREQ_FATAL => q[1]
#     PREREQ_PM => { PPI=>q[0], Getopt::Long=>q[0], Term::ANSIColor=>q[0], Module::List=>q[0], Module::Runtime=>q[0], List::Util=>q[0], Term::ProgressBar::Simple=>q[0], File::Next=>q[0], IO::Interactive=>q[0], Moose=>q[0] }
#     VERSION => q[0.002]
...
MAKE = make
FULLEXT = Perl/Analysis/Static
BASEEXT = Static
PARENT_NAME = Perl::Analysis
DLBASE = $(BASEEXT)
VERSION_FROM = 
OBJECT = 
LDFROM = $(OBJECT)
...
O_FILES  = 
H_FILES  = 
MAN1PODS = scripts/perlanalyst
MAN3PODS = lib/App/Perlanalyst.pm \
...
INST_LIBDIR      = $(INST_LIB)/Perl/Analysis
INST_ARCHLIBDIR  = $(INST_ARCHLIB)/Perl/Analysis
...
TO_INST_PM = lib/App/Perlanalyst.pm \
	lib/Perl/Analysis/Static/Analysis.pm \
	lib/Perl/Analysis/Static/Analysis/Block.pm \
	lib/Perl/Analysis/Static/Analysis/Lexical.pm \
	lib/Perl/Analysis/Static/Analysis/String.pm \
...
PM_TO_BLIB = lib/Perl/Analysis/Static/Filter/Range.pm \
	...
	lib/Perl/Analysis/Static/Element/Block.pm \
	blib/lib/Perl/Analysis/Static/Element/Block.pm \
	lib/Perl/Analysis/Static/Analysis.pm \
...
DISTVNAME = Perl-Analysis-Static-0.002
...
manifypods : pure_all  \
	...
	$(NOECHO) $(POD2MAN) --section=3 --perm_rw=$(PERM_RW) \
	  lib/Perl/Analysis/Static/Filter/Name.pm $(INST_MAN3DIR)/Perl::Analysis::Static::Filter::Name.$(MAN3EXT) \
	  ...
	  lib/Perl/Analysis/Static/Filter/StringLike.pm $(INST_MAN3DIR)/Perl::Analysis::Static::Filter::StringLike.$(MAN3EXT) \
	  ...
	  lib/Perl/Analysis/Static/Element.pm $(INST_MAN3DIR)/Perl::Analysis::Static::Element.$(MAN3EXT) \
	  ...
	  lib/Perl/Analysis/Static/Filter/String.pm $(INST_MAN3DIR)/Perl::Analysis::Static::Filter::String.$(MAN3EXT) \
	  lib/Perl/Analysis/Static/Filter/NameLike.pm $(INST_MAN3DIR)/Perl::Analysis::Static::Filter::NameLike.$(MAN3EXT) \
	  lib/Perl/Analysis/Static/Element/Sub.pm $(INST_MAN3DIR)/Perl::Analysis::Static::Element::Sub.$(MAN3EXT) \
	  lib/Perl/Analysis/Static/Element/Block.pm $(INST_MAN3DIR)/Perl::Analysis::Static::Element::Block.$(MAN3EXT) \
	  ...
	  lib/Perl/Analysis/Static/Files.pm $(INST_MAN3DIR)/Perl::Analysis::Static::Files.$(MAN3EXT) \
...
pure_all :: $(INST_SCRIPT)/perlanalyst
	$(NOECHO) $(NOOP)

realclean ::
	$(RM_F) \
	  $(INST_SCRIPT)/perlanalyst 

$(INST_SCRIPT)/perlanalyst : scripts/perlanalyst $(FIRST_MAKEFILE) $(INST_SCRIPT)$(DFSEP).exists $(INST_BIN)$(DFSEP).exists
	$(NOECHO) $(RM_F) $(INST_SCRIPT)/perlanalyst
	$(CP) scripts/perlanalyst $(INST_SCRIPT)/perlanalyst
	$(FIXIN) $(INST_SCRIPT)/perlanalyst
	-$(NOECHO) $(CHMOD) $(PERM_RWX) $(INST_SCRIPT)/perlanalyst
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) '  Term::ProgressBar::Simple: 0' >> META_new.yml
	...
	$(NOECHO) $(ECHO) '            "Term::ProgressBar::Simple" : 0' >> META_new.json
	$(NOECHO) $(ECHO) '         }' >> META_new.json
	$(NOECHO) $(ECHO) '      }' >> META_new.json
	$(NOECHO) $(ECHO) '   },' >> META_new.json
...
ppd :
	$(NOECHO) $(ECHO) '<SOFTPKG NAME="$(DISTNAME)" VERSION="0.002">' > $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '    <ABSTRACT>Static analysis of Perl documents</ABSTRACT>' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '    <AUTHOR>Gregor Goldbach &lt;glauschwuffel@nomaden.org&gt;</AUTHOR>' >> $(DISTNAME).ppd
	...
	$(NOECHO) $(ECHO) '        <REQUIRE NAME="Term::ProgressBar::Simple" />' >> $(DISTNAME).ppd
